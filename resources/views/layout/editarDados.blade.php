   ...
   <div class="container">
      <div class="row">
         <div class="col-md-8 col-md-offset-2" style="margin: 0 auto">
            <div id="spinner" class="loader hider" style="display:none; -webkit-appearance: none;">Loading...</div>
            <div class="panel panel-default" id= "editarDados">
               ...
               <div class="panel-body">
                  ...
                  <form id="dadosForm"class="form-horizontal" action="{{ url('/clientHome/AlterarDados') }}" method="post">
                     ...
                     <div class="form-group">
                        <label for="apelido" class="col-md-12 control-label">Apelido</label>
                        <div class="col-md-12">
                           <input type="text" id="apelido" class="form-control" name ="apelido">
                        </div>
                     </div>
                     <div class="form-group">
                        <label for="email" class="col-md-12 control-label">Email&nbsp;<i type="button" class="fa fa-question-circle-o fa-lg" data-toggle="tooltip" data-placement="right" title="Se pretender alterar o email terá de proceder ao pedido via email."></i></label>  
                        <div class="col-md-12">
                     ...
                     <div class="form-group">
                        <label for="telemovel" class="col-md-12 control-label">Telemóvel</label>
                        <div class="col-md-12">
                           <input type="text" id="telemovel" class="form-control" name ="telemovel">
                        </div>
                     </div>
                     <div class="form-group">
                        <label for="telemovelDeTrabalho" class="col-md-12 control-label">Telemóvel de Trabalho</label>
                        <div class="col-md-12">
                           <input type="text" id="telemovelDeTrabalho" class="form-control" name ="telemovelDeTrabalho">
                        </div>
                     </div>
                     <div class="form-group">
                        <label for="morada"class="col-md-12 control-label">Morada</label>
                        <div class="col-md-12">
   ...
   $( "#dadosForm" ).submit(function( event ) {
    ...
    function fillInputs() {
           ...
           // vai buscar a info do array php para um array javascript
            ...
            var html ='<button class="btn btn-danger" disabled="disabled" id="pediuExclusao" >O seu email encontra-se excluido, Para voltar a receber informação nossas contacte-nos!</button>'; 
